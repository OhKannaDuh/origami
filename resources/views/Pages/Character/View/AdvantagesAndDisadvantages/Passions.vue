...
export default defineComponent({
    ...
    props: {
        ...
        repository: {
            type: Object as PropType<AdvantageRepository>,
            required: true,
        },
        columns: Object,
        saveManager: {
    ...
    setup(props) {
        const current = ref<App.Models.Character.Advantage[]>(props.character.getAdvantagesOfType('passion'));
        const all = ref<App.Models.Character.Advantage[]>(props.repository.fromType('passion'));
