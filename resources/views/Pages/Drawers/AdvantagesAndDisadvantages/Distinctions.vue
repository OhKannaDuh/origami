...
export default defineComponent({
    ...
    setup(props) {
        const current = ref<App.Models.Character.Advantage[]>(props.args.character.getAdvantagesOfType('distinction'));
        const all = ref<App.Models.Character.Advantage[]>(props.args.repository.fromType('distinction'));
