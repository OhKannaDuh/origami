...
export default defineComponent({
    ...
    setup(props) {
        const current = ref<App.Models.Character.Disadvantage[]>(props.args.character.getDisadvantagesOfType('anxiety'));
        const all = ref<App.Models.Character.Disadvantage[]>(props.args.repository.fromType('anxiety'));
